...
def xor_runner():
    ...
    xor_net_one.train(25, batch_size, report_interval)
    xor_net_one.train(25, batch_size, report_interval, parallel_mode=True, num_worker=2)
    xor_net_one.train(50, batch_size, report_interval, parallel_mode=True, num_worker=3)

    # COMPARE ERRORS AND WEIGHT COST
    # clens - error: 2.30689 weight cost: 15.02701
    clens_error = round(2.30689, 3)
    clens_weight_cost = round(15.02701, 3)
