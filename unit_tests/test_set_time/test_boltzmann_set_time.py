...
from unit_tests.test_boltzmann.test_utils import *

def boltz_xor_unit_test():
    ...
    xor_net_one = sim_one.create_net(name='dbm', type='boltzmann')
    
    # xor_net_one = sim_one.create_net(name='dbm', time_intervals=1,
    #                                 ticks_per_interval=1, type='boltzmann')
    sim_one.add_net(xor_net_one)
    sim_one.set_time(ticks_per_interval=5, time_intervals=4)

    # print(xor_net_one.ticks_per_interval)
    # print(xor_net_one.time_intervals)
    # print(xor_net_one.max_ticks)
