...
def filler_srbptt_runner(parallel):
    ...
    filler_net = sim.create_net(name="filler", type='srbptt')
    sim.add_net(filler_net)
    sim.set_time(time_intervals=5)
    ...
    # load example set
    filler_net.load_example_set("./examples/example_networks/filler_srbptt_examples/filler_example1.ex")
    ...
    clens_error = round(5.57025, 3)
    clens_weight_cost = round(191.556, 3)
